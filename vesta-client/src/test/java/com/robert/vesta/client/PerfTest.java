...
public class PerfTest {
    public static void main(String[] args) throws InterruptedException {
        ApplicationContext ac = new ClassPathXmlApplicationContext("spring/vesta-client-test.xml");
        ...
        System.out.println("QPS: " + ((10000 * 1000 / (System.currentTimeMillis() - lastMilis))));
        long sum = 0;
        long max = 0;
